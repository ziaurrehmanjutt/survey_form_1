<div class="body">
  ...
  <div role="main" class="main py-5">
    <div class="container" id="part-one">
      <section class="question bg-light border p-3 rounded-lg shadow"> <strong class="float-left bg-primary q-number text-center text-white rounded-circle mr-3">164</strong>
        <div class="d-block overflow-hidden">
          <h6 class="h6 mt-2">We sometimes spontaneously and impulsively test new ideas that we generate?</h6>
      ...
      <section class="question bg-light border p-3 rounded-lg shadow mt-4"> <strong class="float-left bg-primary q-number text-center text-white rounded-circle mr-3">165</strong>
        <div class="d-block overflow-hidden">
          <h6 class="h6 mt-2">We implemented feedback from stakeholders without further questioning the overall usefulness</h6>
          <div class="options pt-2">
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="radio1"  />
              <label class="form-check-label">doesn't apply at all</label>
      ...
      <section class="question bg-light border p-3 rounded-lg shadow mt-4"> <strong class="float-left bg-primary q-number text-center text-white rounded-circle mr-3">166</strong>
        <div class="d-block overflow-hidden">
          <h6 class="h6 mt-2">We implemented feedback from stakeholders without further questioning the overall usefulness</h6>
          <div class="options pt-2">
            <div class="form-check form-check-inline">
